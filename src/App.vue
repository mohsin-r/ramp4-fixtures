...
import { IklobFixture } from './fixtures/iklob/main'

onMounted(() => {
  console.log(HelloWorld)
  ;(window as any).debugInstance = null
    ...
    configs: {
      en: {
        ...
        fixtures: {
          ...
          appbar: {
            items: [
              ['diligord-p1', 'iklob-p1', 'mouruge-p1', 'funtimes'],
...
<template>
  ...
  <main>
    <TheWelcome />
    <div style="height: 50vh; margin-top: 10px" id="ramp-instance"></div>
  </main>
</template>
